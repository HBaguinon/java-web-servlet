 ...
 */
public class SunMoonServlet extends HttpServlet
{
    /** This section contains all of the info for the variables.*/
    private static final String USERNAME = "hbagu753";
    private static final String PASSWORD = "wr7Frath";
    ...
    private String dayReq;
    private String yearReq;
    private String cityReq;
    private String stateReq;
    private String baseURL1 = "http://aa.usno.navy.mil/rstt/onedaytable?";
    private URL targetURL;
    
    private String form1Query = "SELECT timeEvent, timeDigital FROM " + table1Name;
    
    private String table2Name;
    private String tableTypeReq;
    private String baseURL2 = "http://aa.usno.navy.mil/cgi-bin/aa_durtablew.pl?";
    private String form2Query =
       "SELECT timeDur FROM " + table2Name + " WHERE monthDur = ? AND dayDur " +
	   "= ?";
    
    private String table3Name;
    private String numPhasesReq;
    private String baseURL3 = "http://aa.usno.navy.mil/cgi-bin/aa_phases.pl?";
    private String form3Query = "SELECT moonPhase, phaseDate FROM " + table3Name;
        
    private String table4Name;
    private String timeZoneReq;
    private String timeZoneWord;
    private String baseURL4 = "http://aa.usno.navy.mil/cgi-bin/aa_moonill2.pl?";
    private String form4Query =
       "SELECT fracMoon FROM " + table4Name + " WHERE monthFrac = ? AND dayFrac " +
	   "= ?";
    
    private String table5Name;
    private String tabIntReq;
    private String baseURL5 = "http://aa.usno.navy.mil/cgi-bin/aa_altazw.pl?";
    private String form5Query = "SELECT timeAlt, Altitude, Azimuth FROM " + table5Name;
     ...
     */
    public URL buildURL1(String monthReq, String dayReq, String yearReq,
     ...
     */
    public String buildTable1Name(String monthReq, String dayReq, String yearReq,
     ...
     * @return targetURL    This is the new URL which was created.
     */
    public URL buildURL2(String tableTypeReq, String yearReq,
     ...
     */
    public String buildTable2Name(String tableTypeReq, String yearReq, 
                          String cityReq, String stateReq)
    {
     ...
     * @return targetURL    This is the new URL which was created.
     */
    public URL buildURL3(String tableTypeReq, String monthReq, String dayReq, 
     ...
     */
    public String buildTable3Name(String tableTypeReq, String monthReq, String dayReq, 
     ...
     * @return targetURL    This is the new URL which was created.
     */
    public URL buildURL4(String tableTypeReq, String yearReq,
     ...
     */
    public String buildTable4Name(String tableTypeReq, String yearReq, 
     ...
     * @return targetURL    This is the new URL which was created.
     */
    public URL buildURL5(String tableTypeReq, String monthReq, String dayReq, 
     ...
     */
    public String buildTable5Name(String tableTypeReq, String monthReq, String dayReq, 
                                    String yearReq, String tabIntReq, String cityReq,
                                    String stateReq)
    {
     ...
     */
	public void createForm1Table(PrintWriter toClient, URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void createForm2Table(PrintWriter toClient, URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
        toClient = res.getWriter();
        InputStream stream = null;
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void createForm3Table(PrintWriter toClient, URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
        toClient = res.getWriter();
        InputStream stream = null;
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void createForm4Table(PrintWriter toClient, URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
        toClient = res.getWriter();
        InputStream stream = null;
        try { // Hook up to the file on the server
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void createForm5Table(PrintWriter toClient, URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
        toClient = res.getWriter();
        InputStream stream = null;
    ...
    {    //Get the response's PrintWriter to return text to the client.
        ...
        try {
            ...
            toClient.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/style.css\" />");
            toClient.println("<script src=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/script.js\" type=\"text/javascript\"/></script>");
            ...
            toClient.println("<ul>");
            toClient.println("<li><a href=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/index.html\">1. One Day</a></li>");
            toClient.println("<li><a href=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/duration.html\">2. Duration</a></li>");
            toClient.println("<li><a href=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/phases.html\">3. Phases</a></li>");
            toClient.println("<li><a href=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/illumination.html\">4. Illumination</a></li>");
            toClient.println("<li><a href=\"http://hbagu753.kutztown.edu:8080/SunMoonInfo/azimuth.html\">5. Azimuth</a></li>");
            toClient.println("</ul>");
            ...
            cookieCheck(req, res, toClient);
            //sessionCheck(req, res, toClient);
        ...
        if (formChoice.equals("formInput1")) {  // Which form?
            ...
            /*try{
            boolean checkTable = checkTableExist(table1Name, tableList, toClient);
            } catch (Exception e) {toClient.println("NOPE.");}*/
            try {
     ...
     * @param toClient      This is used for printing output.
     */
    public void Form1Results(HttpServletRequest req, HttpServletResponse res, PrintWriter toClient) 
                    throws java.io.IOException
    {
        ...
        try {
            ...
            //toClient.println(stmnt+"Unspecified sessioncheck error:"+e+" 3 <BR>");
        }
    }
    ...
    public void ReadWeb1(URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
     PrintWriter toClient = res.getWriter();
     InputStream stream = null;
     try { // Hook up to the file on the server
     ...
     * @param toClient      This is used for printing output.
     */
    public void Form2Results(HttpServletRequest req, HttpServletResponse res, PrintWriter toClient) 
                    throws java.io.IOException
    {   
        toClient.println("<TABLE Caption=\"Query Results\" " +
        "align=\"center\" cellspacing=20><TR><TH>Parameters</TH><TH>"+
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void ReadWeb2(URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
     PrintWriter toClient = res.getWriter();
     InputStream stream = null;
     try { // Hook up to the file on the server
     ...
     * @param toClient      This is used for printing output.
     */
    public void Form3Results(HttpServletRequest req, HttpServletResponse res, PrintWriter toClient) 
                    throws java.io.IOException
    {
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void ReadWeb3(URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
     PrintWriter toClient = res.getWriter();
     InputStream stream = null;
     try { // Hook up to the file on the server
     ...
     * @param toClient      This is used for printing output.
     */
    public void Form4Results(HttpServletRequest req, HttpServletResponse res, PrintWriter toClient) 
                    throws java.io.IOException
    {
        tableTypeReq = req.getParameterValues("tableType")[0];
        toClient.println("<TR><TD>Type of Table is:</TD><TD>" + tableTypeReq + "</TD></TR>");
     ...
     * @param res           This is the HTTP Servlet Response.
     */
    public void ReadWeb4(URL targetURL, HttpServletResponse res) throws java.io.IOException
    {
     PrintWriter toClient = res.getWriter();
     InputStream stream = null;
     try { // Hook up to the file on the server
     ...
     * @param toClient      This is used for printing output.
     */
    public void Form5Results(HttpServletRequest req, HttpServletResponse res, PrintWriter toClient) 
                    throws java.io.IOException
    {
     ...
     */
    public void outputQuery1Results(ResultSet data,PrintWriter out)
     ...
     * @param out      This is used for printing output.
     */
    public void outputQuery2Results(ResultSet data,PrintWriter out)
                                              throws java.sql.SQLException
    // Won't use try..catch here
    {
        out.println("<TABLE Caption=\"Query Results\" " +
     ...
     * @param out      This is used for printing output.
     */
    public void outputQuery3Results(ResultSet data,PrintWriter out)
                                              throws java.sql.SQLException
    // Won't use try..catch here
    {
        out.println("<TABLE Caption=\"Query Results\" " +
     ...
     * @param out      This is used for printing output.
     */
    public void outputQuery4Results(ResultSet data,PrintWriter out)
                                              throws java.sql.SQLException
    // Won't use try..catch here
    {
        out.println("<TABLE Caption=\"Query Results\" " +
     ...
     * @param out      This is used for printing output.
     */
    public void outputQuery5Results(ResultSet data,PrintWriter out)
                                              throws java.sql.SQLException
    // Won't use try..catch here
    {
        if (tableTypeReq.equals("10"))
     ...
     */
    public String MilitaryTime(String preMilitary)
    {
        String postMilitary;
     ...
     */
    public int checkTables(int tableCount, String[] tableList, PrintWriter toClient) 
                     throws java.io.IOException
    {
        tableCount = 0;
    ...
    /**
     * This method checks the name of the table to see if it exists or not. This
     * method is used in lieu of querying the database for the table's
     * existence. It's done in order to minimize processing done by the database
     * server. The method returns true if the table exists, and false otherwise.
     * @param tableName     This is the name of the table to check.
     * @param tableList     This array of strings houses table names.
     * @return tableExists  Boolean value which tells if table exists or not.
     */
    public boolean checkTableExist(String tableName, String[] tableList, PrintWriter toClient)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                tableExists = true;
                toClient.println("Table exists! <BR>");
                break;
            }
        }
        toClient.println("Table does not exist! <BR>");
        return tableExists;
    }
     ...
     * @param toClient      This is used for printing output.
     */
    public void dropTable(String tableName, PrintWriter toClient) throws java.io.IOException
    {
        Statement stmnt;
    ...
    public void cookieCheck (HttpServletRequest req, HttpServletResponse res, 
        PrintWriter toClient) throws ServletException, IOException
    {
        boolean newbie = true;
        Cookie[] cookies = req.getCookies();
        if (cookies != null) {
          // Look for one particular cookie!
          for(int i=0; i<cookies.length; i++) {
            Cookie c = cookies[i];
            if ((c.getName().equals("SunMoonServlet")) &&
        ...
        if (newbie) {
          Cookie returnVisitorCookie =
            new Cookie("SunMoonServlet", "yes");
          returnVisitorCookie.setMaxAge(60*60*24*365); // 1 year
          res.addCookie(returnVisitorCookie);
          title = "Cookie test: Welcome Aboard, Newbie!<BR>";
        } else {
          title = "Cookie test: Welcome Back, Veteran!<BR>";
        }
        res.setContentType("text/html");
        //String docType =
        //  "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 " +
        //  "Transitional//EN\">\n";
        // toClient.println(docType +
    ...
    if (accessCount == null) {
      ...
      heading = "Session check: Welcome, Newcomer<BR>";
    } else {
      heading = "Session check: Welcome Back, Returner<BR>";
    ...
    java.util.Date lastAccessed = new java.util.Date(session.getLastAccessedTime());
    toClient.println("Number of Queries: " + (accessCount+1) + "<BR>");
    /*toClient.println("Heading: " + heading + "Session ID: " + session.getId() + "<BR>" +
                "Creation Time :" + creationTime + "<BR>" +
                "Time of Last Access: " + lastAccessed + "<BR>" +
                "Number of Previous Accesses\n" + accessCount + "<BR>"); */
    session.setAttribute("monthReq", monthReq);
    session.setAttribute("dayReq", dayReq);
    session.setAttribute("yearReq", yearReq);
    session.setAttribute("cityReq", cityReq);
    session.setAttribute("stateReq", stateReq);
    session.setAttribute("tableTypeReq", tableTypeReq);
    session.setAttribute("timeZoneReq", timeZoneReq);
    session.setAttribute("numPhasesReq", numPhasesReq);
    session.setAttribute("tabIntReq", tabIntReq);
    }
}